-- Settings-only optimization - no query structure changes
-- These settings should help the analyzer work more efficiently
...
-- Reduce identifier resolution complexity
SET single_join_prefer_left_table = 1;

-- Expression compilation for repeated patterns
SET compile_expressions = 1;
SET min_count_to_compile_expression = 3;

-- Original query unchanged - let the settings do the work
SELECT order_id,
    if(
