CREATE TEMPORARY TABLE temp_ads AS with campaigns as (
    ...
    where _partition_id in (
            ...
            toString(
                sipHash64('shop-worldwide-mystore.myshopify.com') % 1000
            ),
...
adsets as (
    select distinct IF(
        ...
        adset_bid_strategy,
        adset_bid_amount,
        CAST(NULL AS Nullable(String)) as adset_targeting_arr,
        ai_recommendation,
        ai_target_spend,
...
creatives as (
    select CAST(NULL AS Nullable(String)) as provider_id,
        CAST([] AS Array(String)) as integration_ids,
        CAST(NULL AS Nullable(String)) as campaign_id,
        CAST(NULL AS Nullable(String)) as adset_id,
        CAST(NULL AS Nullable(String)) as ad_id,
        CAST(NULL AS Nullable(Int32)) as numberOfAssets,
        CAST(NULL AS Nullable(String)) as asset_id,
        CAST(NULL AS Nullable(String)) as ad_copy,
        CAST(NULL AS Nullable(String)) as ad_image_url,
        CAST(NULL AS Nullable(String)) as ad_type,
        CAST(NULL AS Nullable(String)) as video_url,
        CAST(NULL AS Nullable(String)) as creative_id,
        CAST(NULL AS Nullable(String)) as creative_distribution_format,
        CAST(NULL AS Nullable(String)) as creative_cta_type,
        CAST(NULL AS Nullable(String)) as creative_format,
        CAST(NULL AS Nullable(String)) as video_url_iframe,
        CAST(NULL AS Nullable(String)) as video_url_source,
        CAST(NULL AS Nullable(Float64)) as video_duration
)
SELECT ads.provider_id as provider_id,
    ...
    CAST(NULL AS Nullable(String)) as asset_id,
    campaign_daily_budget,
    CAST(NULL AS Nullable(Float64)) as suggested_budget,
    CAST(NULL AS Nullable(Float64)) as i_roas,
    CAST(NULL AS Nullable(Float64)) as i_revenue,
    ...
    FROM (
            ...
            from (
                    select * replace(
                        ...
                        LEFT JOIN temp_orders o ON p.order_id = o.order_id
                        left join (
...
overlaps_count AS (
    ...
    FROM temp_base a
        JOIN temp_base b ON a.order_id = b.order_id
