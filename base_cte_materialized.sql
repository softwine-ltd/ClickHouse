-- Step 1: Materialize the currency_conversion CTE first
...
-- Step 2: Main query using the materialized CTE
EXPLAIN
SELECT order_id,
    if(
...
FROM (
        ...
        from (
                select * replace(
                    ...
                    LEFT JOIN (
                        (
                            -- Use materialized currency_conversion_temp instead of CTE
                            ...
                            FROM (
                                ...
                                LEFT JOIN currency_conversion_temp cur ON cur.date = ot.event_date
            ...
            LEFT JOIN currency_conversion_temp cur ON cur.date = p.event_date
...
DROP TABLE currency_conversion_temp;